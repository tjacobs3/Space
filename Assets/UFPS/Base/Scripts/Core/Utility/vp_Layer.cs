...
public sealed class vp_Layer
{
	...
	public static class Mask
	{
		...
		public const int PhysicsBlockers = (1 << vp_Layer.LocalPlayer) | (1 << vp_Layer.MovingPlatform) | (1 << vp_Layer.MovableObject);

		// layer mask for filtering out small and walk-thru objects. (used for explosions)
		public const int IgnoreWalkThru = ~((1 << Debris) | (1 << IgnoreRaycast) |
